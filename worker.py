...
from obsaction.advanced_padder import AdvancedObsPadder
...
if __name__ == '__main__':  # Required for multiprocessing
    ...
    env = SB3MultipleInstanceEnv(get_match, num_instances, wait_time=0, tick_skip=8, gamestate_every_tick=False, dodge_deadzone=0.8)            # Start 1 instances, waiting 60 seconds between each
